...
echo "Test Description: Test WRITE with nonexistent file path" >> ./tests/test-results/write-test.txt
echo "EXPECTED OUTPUT:" >> ./tests/test-results/write-test.txt
echo "'COMMAND: [WRITE]'" >> ./tests/test-results/write-test.txt
...
echo "Test Description: Test WRITE with directory path" >> ./tests/test-results/write-test.txt
echo "EXPECTED OUTPUT:" >> ./tests/test-results/write-test.txt
echo "'COMMAND: [WRITE]'" >> ./tests/test-results/write-test.txt
...
echo "Test Description: Test WRITE with valid file path but no specified remote path" >> ./tests/test-results/write-test.txt
echo "EXPECTED OUTPUT:" >> ./tests/test-results/write-test.txt
echo "'COMMAND: [WRITE]'" >> ./tests/test-results/write-test.txt
...
echo "Test Description: Test WRITE with valid remote path" >> ./tests/test-results/write-test.txt
echo "EXPECTED OUTPUT:" >> ./tests/test-results/write-test.txt
echo "'COMMAND: [WRITE]'" >> ./tests/test-results/write-test.txt
...
rm -f ./client-root/concurrent-test/test-con1.txt
rm -f ./client-root/concurrent-test/test-con2.txt
rm -f ./client-root/concurrent-test/test-con3.txt
touch ./client-root/concurrent-test/test-con1.txt
touch ./client-root/concurrent-test/test-con2.txt
touch ./client-root/concurrent-test/test-con3.txt
